...
public class OptionDialogFrame extends JFrame {
    ...
    private Icon messageIcon = new ImageIcon(getClass().getResource("blue-ball.png"));
    private Object messageObject = new Date();
    private Component messageComponent = new SampleComponent();
    
    public OptionDialogFrame() {
        setTitle("OptionDialogFrame");
    ...
    public Object[] getOptions() {
        ...
        if (s.equals("String[]")) return new String[] { "Yellow", "Blue", "Red" };
            ...
            new ImageIcon(getClass().getResource("yellow-ball.png")),
            new ImageIcon(getClass().getResource("blue-ball.png")),
            new ImageIcon(getClass().getResource("red-ball.png"))
        };
        else if (s.equals("Object[]")) return new Object[] { messageString, messageIcon, 
            messageComponent, messageObject };
        else return null;
        ...
        public void actionPerformed(ActionEvent event) {
            if (typePanel.getSelection().equals("Confirm")) {
                ...
                if (inputPanel.getSelection().equals("Text field")) {
                    ...
                    JOptionPane.showInputDialog(OptionDialogFrame.this, getMessage(), "Title",
                    getType(messageTypePanel), null, new String[] {"Yellow","Blue","Red","Blue"}, "Blue");
                }
            }
